========================================================================
		ActiveX Control DLL : ACEONLINELAUNCHER
========================================================================

ControlWizard has created this project for your ACEONLINELAUNCHER ActiveX Control
...
that make up your ACEONLINELAUNCHER ActiveX Control DLL.

ACEonlineLauncher.dsp
...
ACEonlineLauncher.odl
	This file contains the Object Description Language source code for the
	type library of your control.

/////////////////////////////////////////////////////////////////////////////
ACEonlineLauncher control:

ACEonlineLauncherCtl.h
	This file contains the declaration of the CACEonlineLauncherCtrl C++ class.

ACEonlineLauncherCtl.cpp
	This file contains the implementation of the CACEonlineLauncherCtrl C++ class.

ACEonlineLauncherPpg.h
	This file contains the declaration of the CACEonlineLauncherPropPage C++ class.

ACEonlineLauncherPpg.cpp
	This file contains the implementation of the CACEonlineLauncherPropPage C++ class.

ACEonlineLauncherCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CACEonlineLauncherCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file ACEonlineLauncher.rc.
