...
{
public:
	CAccountData(void) {MEMSET_ZERO(this, sizeof(CAccountData));}
	~CAccountData(void) {}
...
{
public:
	CBuyCashItemData(void)	{MEMSET_ZERO(this,sizeof(CBuyCashItemData));}
...
{
public:
	CCharacterPlayTimeData(void)	{MEMSET_ZERO(this,sizeof(CCharacterPlayTimeData));}
...
{
public:
	CConnectTotalUserCountData(void)	{MEMSET_ZERO(this,sizeof(CConnectTotalUserCountData));}
...
{
public:
	CConnectZoneUserCountData(void)			{MEMSET_ZERO(this,sizeof(CConnectZoneUserCountData));}
...
{
public:
	CEventData(void)			{MEMSET_ZERO(this,sizeof(CEventData));}
	~CEventData(void)			{}
...
{
public:
	CEventParticipationRateData(void)			{MEMSET_ZERO(this,sizeof(CEventParticipationRateData));}
...
{
public:
	CAceUserData(void)				{ MEMSET_ZERO(this,sizeof(CAceUserData)); }
	~CAceUserData(void)				{}
...
{
public:
	CAceConnectUserData(void)		{ MEMSET_ZERO(this,sizeof(CAceConnectUserData)); }
...
{
public:
	CAceItemBuyData(void)				{ MEMSET_ZERO(this,sizeof(CAceItemBuyData)); }
...
{
public:
	CAceConcurrentUserData(void)		{ MEMSET_ZERO(this,sizeof(CAceConcurrentUserData)); }
...
{
public:
	CAceUserPlaytimeData(void)		{ MEMSET_ZERO(this,sizeof(CAceUserPlaytimeData)); }
...
{
public:
	CAccountConnectData(void)		{ MEMSET_ZERO(this,sizeof(CAccountConnectData)); }
...
{
public:
	CCharData(void)		{ MEMSET_ZERO(this,sizeof(CCharData)); }
	~CCharData(void)		{}
...
{
public:
	CItemLog(void)		{ MEMSET_ZERO(this,sizeof(CItemLog)); }
	~CItemLog(void)		{}
...
{
public:
	CItemStateLog(void)		{ MEMSET_ZERO(this,sizeof(CItemStateLog)); }
	~CItemStateLog(void)		{}
...
{
public:
	CServerLog(void)		{ MEMSET_ZERO(this,sizeof(CServerLog)); }
	~CServerLog(void)		{}
