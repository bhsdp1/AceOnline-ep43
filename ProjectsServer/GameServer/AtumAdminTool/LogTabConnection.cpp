...
//	szQuery += " order by l.time desc ";
	...
	MEMSET_ZERO(AccountName, sizeof(AccountName));
	MEMSET_ZERO(&sqlTime, sizeof(SQL_TIMESTAMP_STRUCT));
	MEMSET_ZERO(LogTypeString, sizeof(LogTypeString));
	MEMSET_ZERO(IPAddress, sizeof(IPAddress));
	MEMSET_ZERO(ServerName, sizeof(ServerName));
	MEMSET_ZERO(MACAddress, sizeof(MACAddress));
