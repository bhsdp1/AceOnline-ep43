...
#define	PARTYOP_LIST_START_Y			173 //236
...
#define	PARTYOP_LIST_ON_START_Y			173 //236
...
//wsw
#define DIVISION_COMBO_MAIN_X		ptBkPos.x + 373//138
#define DIVISION_COMBO_MAIN_Y		ptBkPos.y + 90//206
#define DIVISION_COMBO_ELE_X		ptBkPos.x + 373//138
#define DIVISION_COMBO_ELE_Y		ptBkPos.y + 108//224

// 콤보박스
#define	PARTY_FORMAT_COMBO_MAIN_X				32 //262
#define	PARTY_FORMAT_COMBO_MAIN_Y				210 //89
...
// 편대 포맷
#define	COMMUNITY_FORMAT_X				150//391
#define	COMMUNITY_FORMAT_Y				265//124
// 최대 파티수 
#define	MAX_PARTY_LEN					10
...
// 편대 포맷 설명
#define	COMMUNITY_FORMATION_SKILL_DESC_X		35//265
#define	COMMUNITY_FORMATION_SKILL_DESC_Y		230//112
#define	COMMUNITY_FORMATION_SKILL_DESC_WIDTH	118
...

	{
			...
			&& g_pGameMain->GetVoiceType() == VOICE_PARTY)
		{
			...
			if(g_pShuttleChild->m_pClientParty->IsMyShuttleSpeakingAuth())
			{
				...
				//m_pVOIPSpeakingImage->Render(); //warrior
			}
			else
			{
				m_pVOIPImage->Move(nPosX, nPosY);
