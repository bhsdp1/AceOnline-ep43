...
DWORD GetFontColor( char chr )
{
	...
	case OLIVE_FONT:
		return (HFONT_ARGB(0x00, (BYTE)119, (BYTE)187, (BYTE)34));
	case PINK_FONT:
		return (HFONT_ARGB(0x00, (BYTE)255, (BYTE)102, (BYTE)238));
	case LIGHTBLUE_FONT:
		return (HFONT_ARGB(0x00, (BYTE)0, (BYTE)170, (BYTE)255));
	case DARKGREY_FONT:
		return (HFONT_ARGB(0x00, (BYTE)119, (BYTE)119, (BYTE)119));
	case BLACK_FONT:
...
DWORD GetFontColor(char* str)
{
	...
	MEMSET_ZERO(colorParts, sizeof(colorParts[0]) * 3);
