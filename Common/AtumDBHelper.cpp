...
//	BOOL bRet = i_pODBCStmt->ExecuteQuery(QUERY_080702_0057);
	...
	std::fill_n(arrCB, CB_COUNT_ti_EnchantInfo, SQL_NTS);
...
int CAtumDBHelper::DBLoadPetBaseDataInfo( CODBCStatement *i_pODBCStmt , vectorPetDataInfo* o_PetDataInfo )
{
	...
	MEMSET_ZERO(&tmPetData.BaseData, sizeof(tPET_BASEDATA));	// 2015-05-15 Future, memsetting the vector in tPET_BASE_ALL_DATA to 0 causes memory leaks
