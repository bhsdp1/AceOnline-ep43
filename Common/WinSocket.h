...
public:
	...
	CWinSocket(HWND hWnd, UINT wmSock = WM_ASYNC_EVENT, UINT wmNotify = WM_PACKET_NOTIFY, BOOL bEncoding = FALSE, char* szNPlayServerIP_Real = "", char* szNPlayServerIP_BackUp = "");// 2012-10-05 by jhseol, NPlay pc방 모듈 - NPlay 서버 IP 인자 추가
	virtual ~CWinSocket();
